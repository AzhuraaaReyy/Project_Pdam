...
function useDefaultProps({
  ...
  const ctx2 = React29.useContext(PropsContext);
...
function createCssVarsProvider(options) {
  ...
  function CssVarsProvider2(props) {
    ...
    const ctx2 = React33.useContext(ColorSchemeContext);
...
function createGrid(options = {}) {
  ...
  const useUtilityClasses12 = (ownerState, theme) => {
    const {
      container,
      direction,
      spacing: spacing2,
  ...
  const Grid2 = React35.forwardRef(function Grid3(inProps, ref) {
    ...
    const classes = useUtilityClasses12(ownerState, theme);
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react16.forwardRef)((givenProps, givenRef) => {
    ...
    return React42.createElement(Component, { ...usedProps, ref });
  });
};
    ...
    anim.values.forEach((node22, i) => {
      ...
      if (!finished) {
        ...
        if (!is.und(config2.duration)) {
          ...
          position3 = from2 + config2.easing(p) * (to2 - from2);
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React43.createElement(Provider, { value: props }, children);
};
var ctx = makeContext(SpringContext, {});
SpringContext.Provider = ctx.Provider;
SpringContext.Consumer = ctx.Consumer;
function makeContext(target, init) {
  Object.assign(target, React43.createContext(init));
...
var useChartDimensions = (width2, height2, margin2) => {
  ...
  const drawingArea = React45.useMemo(() => ({
...
var DrawingContext = React46.createContext({
  top: 0,
  left: 0,
  bottom: 0,
  right: 0,
...
var SvgContext = React46.createContext({
  isInitialized: false,
  data: {
    current: null
  }
...
function DrawingProvider(props) {
  ...
  const chartId = useId();
  const isPointInside = React46.useCallback(({
    x,
    y
  }, options) => {
  ...
  const value = React46.useMemo(() => _extends({
    chartId: chartId ?? ""
  }, drawingArea, {
    isPointInside
  }), [chartId, drawingArea, isPointInside]);
  const refValue = React46.useMemo(() => ({
    isInitialized: true,
    data: svgRef
  }), [svgRef]);
...
function useDrawingArea() {
  ...
  return React47.useMemo(() => ({
    ...
    right: right3,
    isPointInside
  }), [height2, left3, top3, width2, bottom3, right3, isPointInside]);
}
...
var SeriesContext = React48.createContext({
  isInitialized: false,
  data: {}
});
if (true) {
...
var PluginContext = React49.createContext({
  isInitialized: false,
  data: {
    colorProcessors: {},
    seriesFormatters: {},
...
function PluginProvider(props) {
  ...
  const formattedSeries = React50.useMemo(() => ({
    isInitialized: true,
...
function useXExtremumGetter(seriesType) {
  const {
    isInitialized,
    data
  } = React53.useContext(PluginContext);
  if (!isInitialized) {
    throw new Error(["MUI X: Could not find the plugin context.", "It looks like you rendered your component outside of a ChartsContainer parent component."].join("\n"));
  }
  if (!seriesType) {
...
function useYExtremumGetter(seriesType) {
  const {
    isInitialized,
    data
  } = React54.useContext(PluginContext);
  if (!isInitialized) {
    throw new Error(["MUI X: Could not find the plugin context.", "It looks like you rendered your component outside of a ChartsContainer parent component."].join("\n"));
  }
  if (!seriesType) {
...
function SeriesProvider(props) {
  ...
  const formattedSeries = React57.useMemo(() => ({
    isInitialized: true,
...
function useSeries() {
  const {
    isInitialized,
    data
  } = React58.useContext(SeriesContext);
  if (!isInitialized) {
...
function useBarSeries() {
  ...
  return React58.useMemo(() => series.bar, [series.bar]);
}

// node_modules/@mui/x-charts/context/CartesianProvider/CartesianContext.js
var React59 = __toESM(require_react());
var CartesianContext = React59.createContext({
  isInitialized: false,
  data: {
    xAxis: {},
    yAxis: {},
...
var useCartesianContext = () => {
  const {
    data
  } = React61.useContext(CartesianContext);
  return data;
};
...
var InteractionContext = React62.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React62.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
  ...
  const value = React62.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
...
var HighlightedContext = React63.createContext({
  isInitialized: false,
  data: {
...
function HighlightedProvider({
  ...
  const series = useSeries();
  const seriesById = React64.useMemo(() => {
  ...
  const providerValue = React64.useMemo(() => {
    return {
      isInitialized: true,
      data: {
        highlightScope,
...
function useHighlighted() {
  const {
    isInitialized,
    data
  } = React65.useContext(HighlightedContext);
  if (!isInitialized) {
...
var ZAxisContext = React66.createContext({
  zAxis: {},
  zAxisIds: []
});
if (true) {
...
function ZAxisContextProvider(props) {
  ...
  const zAxis = React66.useMemo(() => inZAxis == null ? void 0 : inZAxis.map((axisConfig) => {
...
function BarElement(props) {
  ...
  return (0, import_jsx_runtime25.jsx)(Bar, _extends({}, barProps));
}
true ? BarElement.propTypes = {
  ...
  dataIndex: import_prop_types23.default.number.isRequired,
...
function useChartId() {
  const {
    chartId
  } = React69.useContext(DrawingContext);
  return React69.useMemo(() => chartId, [chartId]);
}
...
function BarClipRect(props) {
  ...
  return (0, import_jsx_runtime26.jsx)(animated.rect, {
...
function BarClipPath(props) {
  ...
  return (0, import_jsx_runtime26.jsx)("clipPath", {
    id: maskId,
    children: (0, import_jsx_runtime26.jsx)(BarClipRect, {
      ownerState: rest,
      style: style4
    })
  });
...
function BarLabel(inProps) {
  ...
  return (0, import_jsx_runtime27.jsx)(BarLabelComponent, _extends({}, otherProps));
}
...
function BarLabelItem(props) {
  ...
  return (0, import_jsx_runtime28.jsx)(Component, _extends({}, barLabelProps, barLabelOwnerState, {
...
true ? BarLabelItem.propTypes = {
  ...
  color: import_prop_types25.default.string.isRequired,
  dataIndex: import_prop_types25.default.number.isRequired,
  /**
   * The height of the bar.
   */
  height: import_prop_types25.default.number.isRequired,
  seriesId: import_prop_types25.default.oneOfType([import_prop_types25.default.number, import_prop_types25.default.string]).isRequired,
  /**
   * The props used for each component slot.
   * @default {}
   */
...
function BarLabelPlot(props) {
  ...
  return (0, import_jsx_runtime29.jsx)(React75.Fragment, {
    children: barLabelTransition((style4, {
      ...
      width: width2,
      height: height2
    }) => (0, import_jsx_runtime29.jsx)(BarLabelItem, _extends({
      seriesId,
      dataIndex,
      value,
      color: color3,
...
var AnimationContext = React76.createContext({
  isInitialized: false,
  data: {
...
function AnimationProvider(props) {
  ...
  const [skipAnimation2, setSkipAnimation] = React77.useState(isAnimationDisabledEnvironment || void 0);
  useIsomorphicLayoutEffect(() => {
    var _a;
  ...
  return (0, import_jsx_runtime30.jsx)(AnimationContext.Provider, {
    value,
    children
  });
}
...
function useSkipAnimation(skipAnimation2) {
  const {
    isInitialized,
    data
  } = React78.useContext(AnimationContext);
  if (!isInitialized) {
...
var useAxisEvents = (disableAxisListener) => {
  ...
  const {
    dispatch
  } = React80.useContext(InteractionContext);
  const usedXAxis = xAxisIds[0];
  const usedYAxis = yAxisIds[0];
  const mousePosition = React80.useRef({
    isInChart: false,
    x: -1,
    y: -1
  });
...
var ChartsSurface = React81.forwardRef(function ChartsSurface2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiChartsSurface"
  });
...
true ? ChartsSurface.propTypes = {
   ...
   */
  width: import_prop_types27.default.number.isRequired
} : void 0;
...
function ChartsPiecewiseGradient(props) {
  ...
  return (0, import_jsx_runtime33.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold2, index) => {
      ...
      return (0, import_jsx_runtime33.jsxs)(React82.Fragment, {
...
function useChartGradient() {
  const {
    chartId
  } = React84.useContext(DrawingContext);
  return React84.useCallback((axisId, direction) => `${chartId}-gradient-${direction}-${axisId}`, [chartId]);
}
...
var useDefaultizeAxis = (inXAxis, inYAxis, dataset) => {
  const xAxis = React85.useMemo(() => defaultizeAxis(inXAxis, dataset, "x"), [inXAxis, dataset]);
  const yAxis = React85.useMemo(() => defaultizeAxis(inYAxis, dataset, "y"), [inYAxis, dataset]);
  return [xAxis, yAxis];
};
...
var useChartContainerProps = (props, ref) => {
  ...
  const svgRef = React86.useRef(null);
...
var ChartContainer = React87.forwardRef(function ChartContainer2(props, ref) {
  const {
    children,
    drawingProviderProps,
    seriesProviderProps,
  ...
  return (0, import_jsx_runtime36.jsx)(DrawingProvider, _extends({}, drawingProviderProps, {
    children: (0, import_jsx_runtime36.jsx)(PluginProvider, _extends({}, pluginProviderProps, {
      children: (0, import_jsx_runtime36.jsx)(SeriesProvider, _extends({}, seriesProviderProps, {
        children: (0, import_jsx_runtime36.jsx)(CartesianProvider, _extends({}, cartesianProviderProps, {
          children: (0, import_jsx_runtime36.jsx)(ZAxisContextProvider, _extends({}, zAxisContextProps, {
            children: (0, import_jsx_runtime36.jsx)(InteractionProvider, {
              children: (0, import_jsx_runtime36.jsx)(HighlightedProvider, _extends({}, highlightedProviderProps, {
                children: (0, import_jsx_runtime36.jsxs)(ChartsSurface, _extends({}, chartsSurfaceProps, {
                  children: [(0, import_jsx_runtime36.jsx)(ChartsAxesGradients, {}), (0, import_jsx_runtime36.jsx)(AnimationProvider, _extends({}, animationProviderProps, {
                    children
                  }))]
                }))
              }))
...
true ? ChartContainer.propTypes = {
   ...
   * The item currently highlighted. Turns highlighting into a controlled prop.
   */
  highlightedItem: import_prop_types28.default.shape({
    dataIndex: import_prop_types28.default.number,
    seriesId: import_prop_types28.default.oneOfType([import_prop_types28.default.number, import_prop_types28.default.string])
  }),
  /**
   ...
   */
  plugins: import_prop_types28.default.arrayOf(import_prop_types28.default.object),
  /**
   ...
   * The width of the chart in px.
   */
  width: import_prop_types28.default.number.isRequired,
  /**
  ...
  xAxis: import_prop_types28.default.arrayOf(import_prop_types28.default.shape({
    ...
    colorMap: import_prop_types28.default.oneOfType([import_prop_types28.default.shape({
      colors: import_prop_types28.default.arrayOf(import_prop_types28.default.string).isRequired,
      type: import_prop_types28.default.oneOf(["ordinal"]).isRequired,
      unknownColor: import_prop_types28.default.string,
      values: import_prop_types28.default.arrayOf(import_prop_types28.default.oneOfType([import_prop_types28.default.instanceOf(Date), import_prop_types28.default.number, import_prop_types28.default.string]).isRequired)
    }), import_prop_types28.default.shape({
      color: import_prop_types28.default.oneOfType([import_prop_types28.default.arrayOf(import_prop_types28.default.string.isRequired), import_prop_types28.default.func]).isRequired,
      ...
      type: import_prop_types28.default.oneOf(["continuous"]).isRequired
    }), import_prop_types28.default.shape({
      colors: import_prop_types28.default.arrayOf(import_prop_types28.default.string).isRequired,
      thresholds: import_prop_types28.default.arrayOf(import_prop_types28.default.oneOfType([import_prop_types28.default.instanceOf(Date), import_prop_types28.default.number]).isRequired).isRequired,
      type: import_prop_types28.default.oneOf(["piecewise"]).isRequired
    })]),
    ...
    domainLimit: import_prop_types28.default.oneOfType([import_prop_types28.default.oneOf(["nice", "strict"]), import_prop_types28.default.func]),
    ...
    tickLabelPlacement: import_prop_types28.default.oneOf(["middle", "tick"]),
    ...
    tickPlacement: import_prop_types28.default.oneOf(["end", "extremities", "middle", "start"]),
   ...
   * The configuration of the z-axes.
   */
  zAxis: import_prop_types28.default.arrayOf(import_prop_types28.default.shape({
    colorMap: import_prop_types28.default.oneOfType([import_prop_types28.default.shape({
      colors: import_prop_types28.default.arrayOf(import_prop_types28.default.string).isRequired,
      type: import_prop_types28.default.oneOf(["ordinal"]).isRequired,
      unknownColor: import_prop_types28.default.string,
...
var useChartContainerDimensions = (inWidth, inHeight, resolveSizeBeforeRender) => {
  const stateRef = React88.useRef({
    displayError: false,
    initialCompute: true,
    computeRun: 0
  });
  const rootRef = React88.useRef(null);
  const [width2, setWidth] = React88.useState(0);
  const [height2, setHeight] = React88.useState(0);
  const computeSize = React88.useCallback(() => {
...
var ResponsiveChartContainer = React89.forwardRef(function ResponsiveChartContainer2(props, ref) {
  const {
    hasIntrinsicSize,
    chartContainerProps,
    resizableChartContainerProps
  } = useResponsiveChartContainerProps(props, ref);
  return (0, import_jsx_runtime37.jsx)(ResizableContainer, _extends({}, resizableChartContainerProps, {
    children: hasIntrinsicSize ? (0, import_jsx_runtime37.jsx)(ChartContainer, _extends({}, chartContainerProps)) : null
  }));
});
true ? ResponsiveChartContainer.propTypes = {
   ...
   * An array of objects that can be used to populate series and axes data using their `dataKey` property.
   */
  dataset: import_prop_types29.default.arrayOf(import_prop_types29.default.object),
  ...
  highlightedItem: import_prop_types29.default.shape({
    ...
    seriesId: import_prop_types29.default.oneOfType([import_prop_types29.default.number, import_prop_types29.default.string])
  }),
  /**
   * The margin between the SVG and the drawing area.
   * It's used for leaving some space for extra information such as the x- and y-axis or legend.
   ...
   * If not provided, the container supports line, bar, scatter and pie charts.
   */
  plugins: import_prop_types29.default.arrayOf(import_prop_types29.default.object),
  /**
   ...
   * @default false
   */
  resolveSizeBeforeRender: import_prop_types29.default.bool,
  /**
   * The array of series to display.
   * Each type of series has its own specificity.
   * Please refer to the appropriate docs page to learn more about it.
   ...
   * An array of [[AxisConfig]] objects.
   */
  xAxis: import_prop_types29.default.arrayOf(import_prop_types29.default.shape({
    classes: import_prop_types29.default.object,
    colorMap: import_prop_types29.default.oneOfType([import_prop_types29.default.shape({
      colors: import_prop_types29.default.arrayOf(import_prop_types29.default.string).isRequired,
      type: import_prop_types29.default.oneOf(["ordinal"]).isRequired,
      unknownColor: import_prop_types29.default.string,
      values: import_prop_types29.default.arrayOf(import_prop_types29.default.oneOfType([import_prop_types29.default.instanceOf(Date), import_prop_types29.default.number, import_prop_types29.default.string]).isRequired)
    }), import_prop_types29.default.shape({
      color: import_prop_types29.default.oneOfType([import_prop_types29.default.arrayOf(import_prop_types29.default.string.isRequired), import_prop_types29.default.func]).isRequired,
      max: import_prop_types29.default.oneOfType([import_prop_types29.default.instanceOf(Date), import_prop_types29.default.number]),
      min: import_prop_types29.default.oneOfType([import_prop_types29.default.instanceOf(Date), import_prop_types29.default.number]),
      type: import_prop_types29.default.oneOf(["continuous"]).isRequired
    }), import_prop_types29.default.shape({
      colors: import_prop_types29.default.arrayOf(import_prop_types29.default.string).isRequired,
      thresholds: import_prop_types29.default.arrayOf(import_prop_types29.default.oneOfType([import_prop_types29.default.instanceOf(Date), import_prop_types29.default.number]).isRequired).isRequired,
      type: import_prop_types29.default.oneOf(["piecewise"]).isRequired
    })]),
    data: import_prop_types29.default.array,
    dataKey: import_prop_types29.default.string,
    disableLine: import_prop_types29.default.bool,
    disableTicks: import_prop_types29.default.bool,
    domainLimit: import_prop_types29.default.oneOfType([import_prop_types29.default.oneOf(["nice", "strict"]), import_prop_types29.default.func]),
    fill: import_prop_types29.default.string,
    hideTooltip: import_prop_types29.default.bool,
    ...
    labelFontSize: import_prop_types29.default.number,
    labelStyle: import_prop_types29.default.object,
    max: import_prop_types29.default.oneOfType([import_prop_types29.default.instanceOf(Date), import_prop_types29.default.number]),
    min: import_prop_types29.default.oneOfType([import_prop_types29.default.instanceOf(Date), import_prop_types29.default.number]),
    position: import_prop_types29.default.oneOf(["bottom", "top"]),
    reverse: import_prop_types29.default.bool,
    scaleType: import_prop_types29.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types29.default.object,
    slots: import_prop_types29.default.object,
    stroke: import_prop_types29.default.string,
    sx: import_prop_types29.default.oneOfType([import_prop_types29.default.arrayOf(import_prop_types29.default.oneOfType([import_prop_types29.default.func, import_prop_types29.default.object, import_prop_types29.default.bool])), import_prop_types29.default.func, import_prop_types29.default.object]),
    tickFontSize: import_prop_types29.default.number,
    tickInterval: import_prop_types29.default.oneOfType([import_prop_types29.default.oneOf(["auto"]), import_prop_types29.default.array, import_prop_types29.default.func]),
    tickLabelInterval: import_prop_types29.default.oneOfType([import_prop_types29.default.oneOf(["auto"]), import_prop_types29.default.func]),
    tickLabelPlacement: import_prop_types29.default.oneOf(["middle", "tick"]),
    tickLabelStyle: import_prop_types29.default.object,
    tickMaxStep: import_prop_types29.default.number,
    tickMinStep: import_prop_types29.default.number,
    tickNumber: import_prop_types29.default.number,
    tickPlacement: import_prop_types29.default.oneOf(["end", "extremities", "middle", "start"]),
    tickSize: import_prop_types29.default.number,
    valueFormatter: import_prop_types29.default.func
  })),
  /**
   * The configuration of the y-axes.
   * If not provided, a default axis config is used.
   * An array of [[AxisConfig]] objects.
   */
  yAxis: import_prop_types29.default.arrayOf(import_prop_types29.default.shape({
    classes: import_prop_types29.default.object,
    colorMap: import_prop_types29.default.oneOfType([import_prop_types29.default.shape({
      colors: import_prop_types29.default.arrayOf(import_prop_types29.default.string).isRequired,
      type: import_prop_types29.default.oneOf(["ordinal"]).isRequired,
    ...
    max: import_prop_types29.default.oneOfType([import_prop_types29.default.instanceOf(Date), import_prop_types29.default.number]),
    min: import_prop_types29.default.oneOfType([import_prop_types29.default.instanceOf(Date), import_prop_types29.default.number]),
    position: import_prop_types29.default.oneOf(["left", "right"]),
    reverse: import_prop_types29.default.bool,
    scaleType: import_prop_types29.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types29.default.object,
    slots: import_prop_types29.default.object,
   ...
   * The configuration of the z-axes.
   */
  zAxis: import_prop_types29.default.arrayOf(import_prop_types29.default.shape({
    colorMap: import_prop_types29.default.oneOfType([import_prop_types29.default.shape({
      colors: import_prop_types29.default.arrayOf(import_prop_types29.default.string).isRequired,
      type: import_prop_types29.default.oneOf(["ordinal"]).isRequired,
      unknownColor: import_prop_types29.default.string,
...
function ChartsText(props) {
  ...
  const wordsByLines = React90.useMemo(() => getWordsByLines({
    style: style4,
  ...
  return (0, import_jsx_runtime38.jsx)("text", _extends({}, textProps, {
    ...
    dominantBaseline,
    style: style4,
    children: wordsByLines.map((line2, index) => (0, import_jsx_runtime38.jsx)("tspan", {
      x,
...
true ? ChartsText.propTypes = {
   ...
   */
  lineHeight: import_prop_types30.default.number,
  /**
   * If `true`, the line width is computed.
   * @default false
   */
  needsComputation: import_prop_types30.default.bool,
   ...
   * Text displayed.
   */
  text: import_prop_types30.default.string.isRequired
} : void 0;
...
function useMounted(defer = false) {
  const [mountedState, setMountedState] = React91.useState(false);
  useEnhancedEffect_default(() => {
    if (!defer) {
...
function ChartsXAxis(inProps) {
  ...
  return (0, import_jsx_runtime39.jsxs)(XAxisRoot, {
    transform: `translate(0, ${position3 === "bottom" ? top3 + height2 : top3})`,
    className: classes.root,
    sx,
    children: [!disableLine && (0, import_jsx_runtime39.jsx)(Line, _extends({
      x1: left3,
      x2: left3 + width2,
      ...
      return (0, import_jsx_runtime39.jsxs)("g", {
        transform: `translate(${offset2}, 0)`,
        className: classes.tickContainer,
        children: [!disableTicks && showTick && (0, import_jsx_runtime39.jsx)(Tick, _extends({
          y2: positionSign * tickSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && showTickLabel && (0, import_jsx_runtime39.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel
        }, axisTickLabelProps, {
    ...
    }), label && (0, import_jsx_runtime39.jsx)("g", {
      className: classes.label,
      children: (0, import_jsx_runtime39.jsx)(Label, _extends({}, labelRefPoint, axisLabelProps, {
        text: label
      }))
    })]
  });
...
true ? ChartsXAxis.propTypes = {
   ...
   */
  axisId: import_prop_types31.default.oneOfType([import_prop_types31.default.number, import_prop_types31.default.string]),
  /**
   * Override or extend the styles applied to the component.
   */
...
function ChartsYAxis(inProps) {
  ...
  const TickLabel = (slots == null ? void 0 : slots.axisTickLabel) ?? ChartsText;
  const Label = (slots == null ? void 0 : slots.axisLabel) ?? ChartsText;
  const revertAnchor = !isRtl && position3 === "right" || isRtl && position3 !== "right";
  const axisTickLabelProps = useSlotProps_default({
    elementType: TickLabel,
    externalSlotProps: slotProps == null ? void 0 : slotProps.axisTickLabel,
    additionalProps: {
  ...
  return (0, import_jsx_runtime40.jsxs)(YAxisRoot, {
    transform: `translate(${position3 === "right" ? left3 + width2 : left3}, 0)`,
    className: classes.root,
    sx,
    children: [!disableLine && (0, import_jsx_runtime40.jsx)(Line, _extends({
      y1: top3,
      y2: top3 + height2,
      className: classes.line
      ...
      return (0, import_jsx_runtime40.jsxs)("g", {
        transform: `translate(0, ${offset2})`,
        className: classes.tickContainer,
        children: [!disableTicks && (0, import_jsx_runtime40.jsx)(Tick, _extends({
          x2: positionSign * tickSize,
          className: classes.tick
        }, slotProps == null ? void 0 : slotProps.axisTick)), formattedValue !== void 0 && !skipLabel && (0, import_jsx_runtime40.jsx)(TickLabel, _extends({
          x: xTickLabel,
          y: yTickLabel,
          text: formattedValue.toString()
        }, axisTickLabelProps))]
      }, index);
    }), label && (0, import_jsx_runtime40.jsx)("g", {
      className: classes.label,
      children: (0, import_jsx_runtime40.jsx)(Label, _extends({}, labelRefPoint, axisLabelProps, {
        text: label
      }))
    })]
  });
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime41.jsxs)(React94.Fragment, {
    children: [topId && (0, import_jsx_runtime41.jsx)(ChartsXAxis, _extends({}, topAxisProps, {
      position: "top",
      axisId: topId
    })), bottomId && (0, import_jsx_runtime41.jsx)(ChartsXAxis, _extends({}, bottomAxisProps, {
      position: "bottom",
      axisId: bottomId
    })), leftId && (0, import_jsx_runtime41.jsx)(ChartsYAxis, _extends({}, leftAxisProps, {
      position: "left",
      axisId: leftId
    })), rightId && (0, import_jsx_runtime41.jsx)(ChartsYAxis, _extends({}, rightAxisProps, {
      position: "right",
      axisId: rightId
    }))]
  });
...
true ? ChartsAxis.propTypes = {
   ...
   */
  bottomAxis: import_prop_types33.default.oneOfType([import_prop_types33.default.object, import_prop_types33.default.string]),
  /**
   * Indicate which axis to display the left of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default yAxisIds[0] The id of the first provided axis
   */
  leftAxis: import_prop_types33.default.oneOfType([import_prop_types33.default.object, import_prop_types33.default.string]),
  /**
   * Indicate which axis to display the right of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default null
   */
  rightAxis: import_prop_types33.default.oneOfType([import_prop_types33.default.object, import_prop_types33.default.string]),
  /**
   * The props used for each component slot.
   * @default {}
   */
   ...
   * @default null
   */
  topAxis: import_prop_types33.default.oneOfType([import_prop_types33.default.object, import_prop_types33.default.string])
} : void 0;
...
var Portal = React95.forwardRef(function Portal2(props, forwardedRef) {
  const {
    children,
    container,
    disablePortal = false
  } = props;
  const [mountNode, setMountNode] = React95.useState(null);
  const handleRef = useForkRef(React95.isValidElement(children) ? getReactElementRef(children) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React95.isValidElement(children)) {
      const newProps = {
        ref: handleRef
      };
      return React95.cloneElement(children, newProps);
    }
    return children;
  }
...
var PopperTooltip = React96.forwardRef(function PopperTooltip2(props, forwardedRef) {
  const {
    anchorEl,
    children,
    direction,
  ...
  const popperRef = React96.useRef(null);
  const handlePopperRef = useForkRef(popperRef, popperRefProp);
  const handlePopperRefRef = React96.useRef(handlePopperRef);
  useEnhancedEffect_default(() => {
    handlePopperRefRef.current = handlePopperRef;
  }, [handlePopperRef]);
  React96.useImperativeHandle(popperRefProp, () => popperRef.current, []);
  const rtlPlacement = flipPlacement(initialPlacement, direction);
  const [placement, setPlacement] = React96.useState(rtlPlacement);
  const [resolvedAnchorElement, setResolvedAnchorElement] = React96.useState(resolveAnchorEl(anchorEl));
  React96.useEffect(() => {
...
var Popper = React96.forwardRef(function Popper2(props, forwardedRef) {
  const {
    anchorEl,
    children,
  ...
  return (0, import_jsx_runtime42.jsx)(Portal_default, {
    disablePortal,
    container,
    children: (0, import_jsx_runtime42.jsx)(PopperTooltip, {
      anchorEl,
      direction,
      disablePortal,
      modifiers,
...
function GlobalStyles3(props) {
  return (0, import_jsx_runtime43.jsx)(GlobalStyles_default, {
    ...props,
    defaultTheme: defaultTheme_default,
    themeId: identifier_default
  });
...
function DefaultPropsProvider2(props) {
  return (0, import_jsx_runtime45.jsx)(DefaultPropsProvider_default, {
    ...props
  });
}
true ? DefaultPropsProvider2.propTypes = {
   ...
   * @ignore
   */
  value: import_prop_types37.default.object.isRequired
} : void 0;
...
var Popper3 = React100.forwardRef(function Popper4(inProps, ref) {
  const isRtl = useRtl();
  ...
  return (0, import_jsx_runtime46.jsx)(PopperRoot, {
    as: component,
...
function NoSsr(props) {
  ...
  const [mountedState, setMountedState] = React101.useState(false);
  useEnhancedEffect_default(() => {
    if (!defer) {
      setMountedState(true);
    }
...
function useMouseTracker() {
  const svgRef = useSvgRef();
  const [mousePosition, setMousePosition] = React102.useState(null);
  React102.useEffect(() => {
    const element = svgRef.current;
    if (element === null) {
      return () => {
...
function DefaultChartsItemTooltipContent(props) {
  ...
  return (0, import_jsx_runtime47.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.paper,
    children: (0, import_jsx_runtime47.jsx)(ChartsTooltipTable, {
      className: classes.table,
      children: (0, import_jsx_runtime47.jsx)("tbody", {
        children: (0, import_jsx_runtime47.jsxs)(ChartsTooltipRow, {
          className: classes.row,
          children: [(0, import_jsx_runtime47.jsx)(ChartsTooltipCell, {
            className: clsx_default(classes.markCell, classes.cell),
            children: (0, import_jsx_runtime47.jsx)(ChartsTooltipMark, {
              color: color3,
              className: classes.mark
            })
          }), (0, import_jsx_runtime47.jsx)(ChartsTooltipCell, {
...
true ? DefaultChartsItemTooltipContent.propTypes = {
   ...
   */
  getColor: import_prop_types40.default.func.isRequired,
  /**
   ...
   */
  series: import_prop_types40.default.object.isRequired,
...
function ChartsItemTooltipContent(props) {
  ...
  const {
    zAxis,
    zAxisIds
  } = React104.useContext(ZAxisContext);
  ...
  return (0, import_jsx_runtime48.jsx)(Content, _extends({}, chartTooltipContentProps));
}
...
var Typography = React105.forwardRef(function Typography2(inProps, ref) {
  const {
    color: color3,
    ...themeProps
  } = useDefaultProps2({
  ...
  return (0, import_jsx_runtime49.jsx)(TypographyRoot, {
    as: Component,
    ref,
    className: clsx_default(classes.root, className),
    ...other,
...
function DefaultChartsAxisTooltipContent(props) {
  ...
  return (0, import_jsx_runtime50.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.paper,
    children: (0, import_jsx_runtime50.jsxs)(ChartsTooltipTable, {
      className: classes.table,
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime50.jsx)("thead", {
        children: (0, import_jsx_runtime50.jsx)(ChartsTooltipRow, {
          children: (0, import_jsx_runtime50.jsx)(ChartsTooltipCell, {
            colSpan: 3,
            children: (0, import_jsx_runtime50.jsx)(Typography_default, {
      ...
      }), (0, import_jsx_runtime50.jsx)("tbody", {
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime50.jsxs)(ChartsTooltipRow, {
            className: classes.row,
            children: [(0, import_jsx_runtime50.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.markCell, classes.cell),
              children: color3 && (0, import_jsx_runtime50.jsx)(ChartsTooltipMark, {
                color: color3,
                className: classes.mark
              })
            }), (0, import_jsx_runtime50.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.labelCell, classes.cell),
              children: formattedLabel ? (0, import_jsx_runtime50.jsx)(Typography_default, {
...
true ? DefaultChartsAxisTooltipContent.propTypes = {
   ...
   */
  axis: import_prop_types42.default.object.isRequired,
  /**
   ...
   * The series linked to the triggered axis.
   */
  series: import_prop_types42.default.arrayOf(import_prop_types42.default.object).isRequired,
...
function ChartsAxisTooltipContent(props) {
  ...
  const relevantSeries = React107.useMemo(() => {
    const rep = [];
  ...
  const relevantAxis = React107.useMemo(() => {
  ...
  return (0, import_jsx_runtime51.jsx)(Content, _extends({}, chartTooltipContentProps));
}
...
function ChartsTooltip(inProps) {
  ...
  const {
    item,
    axis
  } = React108.useContext(InteractionContext);
  ...
  return (0, import_jsx_runtime52.jsx)(NoSsr_default, {
    children: popperOpen && (0, import_jsx_runtime52.jsx)(PopperComponent, _extends({}, popperProps, {
      className: classes.root,
      children: trigger === "item" ? (0, import_jsx_runtime52.jsx)(ChartsItemTooltipContent, {
        ...
        classes
      }) : (0, import_jsx_runtime52.jsx)(ChartsAxisTooltipContent, {
...
function ChartsLegendItem(props) {
  ...
  return (0, import_jsx_runtime53.jsxs)("g", {
    ...
    children: [(0, import_jsx_runtime53.jsx)("rect", {
    ...
    }), (0, import_jsx_runtime53.jsx)("rect", {
    ...
    }), (0, import_jsx_runtime53.jsx)(ChartsText, {
      style: _extends({
        pointerEvents: "none"
      }, labelStyle),
      text: label,
...
function LegendPerItem(props) {
  ...
  const theme = useTheme5();
  const drawingArea = useDrawingArea();
  const labelStyle = React112.useMemo(
  ...
  const padding2 = React112.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React112.useCallback((label, inStyle = {}) => {
  ...
  const [itemsWithPosition, legendWidth, legendHeight] = React112.useMemo(() => legendItemPlacements(itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap), [itemsToDisplay, getItemSpace, labelStyle, direction, availableWidth, availableHeight, itemGap]);
  const gapX = React112.useMemo(() => {
  ...
  return (0, import_jsx_runtime54.jsx)(NoSsr_default, {
    children: (0, import_jsx_runtime54.jsx)(ChartsLegendRoot, {
      className: classes == null ? void 0 : classes.root,
      children: itemsWithPosition.map((item, i) => (0, import_react22.createElement)(ChartsLegendItem, _extends({}, item, {
        key: item.id,
        gapX,
        gapY,
        legendWidth,
...
function DefaultChartsLegend(props) {
  ...
  return (0, import_jsx_runtime55.jsx)(LegendPerItem, _extends({}, other, {
...
true ? DefaultChartsLegend.propTypes = {
  ...
  seriesToDisplay: import_prop_types44.default.arrayOf(import_prop_types44.default.shape({
    ...
    itemId: import_prop_types44.default.oneOfType([import_prop_types44.default.number, import_prop_types44.default.string]),
    label: import_prop_types44.default.string.isRequired,
    maxValue: import_prop_types44.default.oneOfType([import_prop_types44.default.instanceOf(Date), import_prop_types44.default.number]),
    minValue: import_prop_types44.default.oneOfType([import_prop_types44.default.instanceOf(Date), import_prop_types44.default.number]),
    seriesId: import_prop_types44.default.oneOfType([import_prop_types44.default.number, import_prop_types44.default.string])
  })).isRequired
} : void 0;
...
function ChartsLegend(inProps) {
  ...
  const theme = useTheme5();
  const classes = useUtilityClasses9(_extends({}, defaultizedProps, {
    theme
  }));
  const drawingArea = useDrawingArea();
  const series = useSeries();
  ...
  return (0, import_jsx_runtime56.jsx)(ChartLegendRender, _extends({}, chartLegendRenderProps));
}
...
function useAxis({
  ...
  const {
    zAxis,
    zAxisIds
  } = React115.useContext(ZAxisContext);
...
function getPositionOffset(position3, legendBox, svgBox) {
  let offsetX = 0;
  let offsetY = 0;
  switch (position3.horizontal) {
    case "left":
...
function ContinuousColorLegend(props) {
  ...
  const refLength = direction === "column" ? height2 + top3 + bottom3 : width2 + left3 + right3;
  const size = getPercentageValue(length2, refLength);
  ...
  const svgBoundingBox = {
    width: width2 + left3 + right3,
    height: height2 + top3 + bottom3
  };
  const positionOffset = getPositionOffset(_extends({
    horizontal: "middle",
    vertical: "top"
  }, position3), legendPositions.boundingBox, svgBoundingBox);
  return (0, import_jsx_runtime57.jsxs)(React116.Fragment, {
    ...
    }), (0, import_jsx_runtime57.jsx)("rect", _extends({
...
true ? ContinuousColorLegend.propTypes = {
   ...
   * @default 'middle'
   */
  align: import_prop_types46.default.oneOf(["end", "middle", "start"]),
  /**
   * The axis direction containing the color configuration to represent.
   * @default 'z'
   */
  axisDirection: import_prop_types46.default.oneOf(["x", "y", "z"]),
  /**
   ...
   * @default '50%'
   */
  length: import_prop_types46.default.oneOfType([import_prop_types46.default.number, import_prop_types46.default.string]),
  /**
   ...
   */
  maxLabel: import_prop_types46.default.oneOfType([import_prop_types46.default.func, import_prop_types46.default.string]),
  /**
   * The label to display at the minimum side of the gradient.
   * Can either be a string, or a function.
   * @default ({ formattedValue }) => formattedValue
   */
  minLabel: import_prop_types46.default.oneOfType([import_prop_types46.default.func, import_prop_types46.default.string]),
  /**
   * The position of the legend.
   */
   ...
   * @default 'linear'
   */
  scaleType: import_prop_types46.default.oneOf(["linear", "log", "pow", "sqrt", "time", "utc"]),
  /**
...
function PiecewiseColorLegend(props) {
  ...
  const itemsToDisplay = colorMap.colors.map((color3, index) => {
  ...
  return (0, import_jsx_runtime58.jsx)(LegendPerItem, _extends({}, other, {
    itemsToDisplay,
...
true ? PiecewiseColorLegend.propTypes = {
   ...
   * @default 'z'
   */
  axisDirection: import_prop_types47.default.oneOf(["x", "y", "z"]),
  /**
   * The id of the axis item with the color configuration to represent.
   * @default The first axis item.
   */
   ...
   * The default depends on the chart.
   */
  direction: import_prop_types47.default.oneOf(["column", "row"]).isRequired,
  /**
   * Hide the first item of the legend, corresponding to the [-infinity, min] piece.
   * @default false
   */
  hideFirst: import_prop_types47.default.bool,
  /**
   * Hide the last item of the legend, corresponding to the [max, +infinity] piece.
   * @default false
   */
  hideLast: import_prop_types47.default.bool,
  /**
   * Space between two legend items (in px).
   * @default 10
   */
  itemGap: import_prop_types47.default.number,
  /**
   * Height of the item mark (in px).
   * @default 20
   */
  itemMarkHeight: import_prop_types47.default.number,
  /**
   * Width of the item mark (in px).
   * @default 20
   */
  itemMarkWidth: import_prop_types47.default.number,
  /**
   * Format the legend labels.
   * @param {PiecewiseLabelFormatterParams} params The bound of the piece to format.
   * @returns {string|null} The displayed label, or `null` to skip the item.
   */
  labelFormatter: import_prop_types47.default.func,
  /**
   * Style applied to legend labels.
   * @default theme.typography.subtitle1
   */
   ...
   * @default 5
   */
  markGap: import_prop_types47.default.number,
  /**
   * Callback fired when a legend item is clicked.
   * @param {React.MouseEvent<SVGRectElement, MouseEvent>} event The click event.
   ...
   * @default 10
   */
  padding: import_prop_types47.default.oneOfType([import_prop_types47.default.number, import_prop_types47.default.shape({
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime59.jsxs)(React118.Fragment, {
    children: [isBandScaleX && xScale(axisX.value) !== void 0 && (0, import_jsx_runtime59.jsx)(
    ...
    ), isBandScaleY && yScale(axisY.value) !== void 0 && (0, import_jsx_runtime59.jsx)(ChartsAxisHighlightPath, {
    ...
    }), xAxisHighlight === "line" && axis.x !== null && (0, import_jsx_runtime59.jsx)(ChartsAxisHighlightPath, {
      d: `M ${getXPosition(axis.x.value)} ${yScale.range()[0]} L ${getXPosition(axis.x.value)} ${yScale.range()[1]}`,
      className: classes.root,
      ownerState: {
        axisHighlight: "line"
      }
    }), yAxisHighlight === "line" && axis.y !== null && (0, import_jsx_runtime59.jsx)(ChartsAxisHighlightPath, {
...
function ChartsClipPath(props) {
  ...
  return (0, import_jsx_runtime60.jsx)("clipPath", {
    id,
...
true ? ChartsClipPath.propTypes = {
  ...
  offset: import_prop_types49.default.shape({
...
function ChartsGridVertical(props) {
  ...
  return (0, import_jsx_runtime61.jsx)(React120.Fragment, {
    children: xTicks.map(({
      value,
      offset: offset2
    }) => (0, import_jsx_runtime61.jsx)(GridLine, {
      y1: drawingArea.top,
...
function ChartsGridHorizontal(props) {
  ...
  return (0, import_jsx_runtime62.jsx)(React121.Fragment, {
    children: yTicks.map(({
      value,
      offset: offset2
    }) => (0, import_jsx_runtime62.jsx)(GridLine, {
      y1: offset2,
      y2: offset2,
      x1: drawingArea.left,
...
function ChartsGrid(inProps) {
  ...
  return (0, import_jsx_runtime63.jsxs)(GridRoot, _extends({}, other, {
    className: classes.root,
    children: [vertical && (0, import_jsx_runtime63.jsx)(ChartsGridVertical, {
      axis: verticalAxis,
      drawingArea,
      classes
    }), horizontal && (0, import_jsx_runtime63.jsx)(ChartsGridHorizontal, {
      axis: horizontalAxis,
      drawingArea,
      classes
    })]
...
function ChartsOnAxisClickHandler(props) {
  ...
  const {
    axis
  } = React123.useContext(InteractionContext);
  const {
    xAxisIds,
    xAxis,
    yAxisIds,
  ...
  return (0, import_jsx_runtime64.jsx)(React123.Fragment, {});
}
true ? ChartsOnAxisClickHandler.propTypes = {
   ...
   */
  onAxisClick: import_prop_types51.default.func
} : void 0;
...
function ChartsLoadingOverlay(props) {
  ...
  return (0, import_jsx_runtime65.jsx)(StyledText, _extends({
    x: left3 + width2 / 2,
    y: top3 + height2 / 2
  }, other, {
...
function ChartsNoDataOverlay(props) {
  ...
  return (0, import_jsx_runtime66.jsx)(StyledText2, _extends({
    x: left3 + width2 / 2,
    y: top3 + height2 / 2
  }, other, {
...
function ChartsOverlay(props) {
  ...
  if (props.loading) {
    ...
    return (0, import_jsx_runtime67.jsx)(LoadingOverlay, _extends({}, (_b = props.slotProps) == null ? void 0 : _b.loadingOverlay));
  }
  if (noData) {
    const NoDataOverlay = ((_c = props.slots) == null ? void 0 : _c.noDataOverlay) ?? ChartsNoDataOverlay;
    return (0, import_jsx_runtime67.jsx)(NoDataOverlay, _extends({}, (_d = props.slotProps) == null ? void 0 : _d.noDataOverlay));
  }
  return null;
}
...
var BarChart = React127.forwardRef(function BarChart2(inProps, ref) {
  const props = useThemeProps2({
    props: inProps,
    name: "MuiBarChart"
  });
  ...
  return (0, import_jsx_runtime68.jsxs)(ResponsiveChartContainer, _extends({
    ref
  }, chartContainerProps, {
    children: [props.onAxisClick && (0, import_jsx_runtime68.jsx)(ChartsOnAxisClickHandler, _extends({}, axisClickHandlerProps)), (0, import_jsx_runtime68.jsx)(ChartsGrid, _extends({}, gridProps)), (0, import_jsx_runtime68.jsxs)("g", _extends({}, clipPathGroupProps, {
      children: [(0, import_jsx_runtime68.jsx)(BarPlot, _extends({}, barPlotProps)), (0, import_jsx_runtime68.jsx)(ChartsOverlay, _extends({}, overlayProps)), (0, import_jsx_runtime68.jsx)(ChartsAxisHighlight, _extends({}, axisHighlightProps))]
    })), (0, import_jsx_runtime68.jsx)(ChartsAxis, _extends({}, chartsAxisProps)), (0, import_jsx_runtime68.jsx)(ChartsLegend, _extends({}, legendProps)), !props.loading && (0, import_jsx_runtime68.jsx)(ChartsTooltip, _extends({}, tooltipProps)), (0, import_jsx_runtime68.jsx)(ChartsClipPath, _extends({}, clipPathProps)), children]
  }));
});
true ? BarChart.propTypes = {
   ...
   * @default xAxisIds[0] The id of the first provided axis
   */
  bottomAxis: import_prop_types52.default.oneOfType([import_prop_types52.default.object, import_prop_types52.default.string]),
  ...
  highlightedItem: import_prop_types52.default.shape({
    ...
    seriesId: import_prop_types52.default.oneOfType([import_prop_types52.default.number, import_prop_types52.default.string])
  }),
  /**
   ...
   * @default yAxisIds[0] The id of the first provided axis
   */
  leftAxis: import_prop_types52.default.oneOfType([import_prop_types52.default.object, import_prop_types52.default.string]),
  /**
   * @deprecated Consider using `slotProps.legend` instead.
   */
  legend: import_prop_types52.default.shape({
    classes: import_prop_types52.default.object,
    direction: import_prop_types52.default.oneOf(["column", "row"]),
   ...
   * @default false
   */
  resolveSizeBeforeRender: import_prop_types52.default.bool,
  /**
   * Indicate which axis to display the right of the charts.
   * Can be a string (the id of the axis) or an object `ChartsYAxisProps`.
   * @default null
   */
  rightAxis: import_prop_types52.default.oneOfType([import_prop_types52.default.object, import_prop_types52.default.string]),
  /**
   ...
   */
  tooltip: import_prop_types52.default.shape({
    axisContent: import_prop_types52.default.elementType,
    classes: import_prop_types52.default.object,
    itemContent: import_prop_types52.default.elementType,
    slotProps: import_prop_types52.default.object,
    slots: import_prop_types52.default.object,
    trigger: import_prop_types52.default.oneOf(["axis", "item", "none"])
  }),
  /**
   * Indicate which axis to display the top of the charts.
   * Can be a string (the id of the axis) or an object `ChartsXAxisProps`.
   * @default null
   */
  topAxis: import_prop_types52.default.oneOfType([import_prop_types52.default.object, import_prop_types52.default.string]),
   ...
   * An array of [[AxisConfig]] objects.
   */
  xAxis: import_prop_types52.default.arrayOf(import_prop_types52.default.shape({
    classes: import_prop_types52.default.object,
    ...
    labelFontSize: import_prop_types52.default.number,
    labelStyle: import_prop_types52.default.object,
    max: import_prop_types52.default.oneOfType([import_prop_types52.default.instanceOf(Date), import_prop_types52.default.number]),
    min: import_prop_types52.default.oneOfType([import_prop_types52.default.instanceOf(Date), import_prop_types52.default.number]),
    position: import_prop_types52.default.oneOf(["bottom", "top"]),
    reverse: import_prop_types52.default.bool,
    scaleType: import_prop_types52.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types52.default.object,
    slots: import_prop_types52.default.object,
    stroke: import_prop_types52.default.string,
    sx: import_prop_types52.default.oneOfType([import_prop_types52.default.arrayOf(import_prop_types52.default.oneOfType([import_prop_types52.default.func, import_prop_types52.default.object, import_prop_types52.default.bool])), import_prop_types52.default.func, import_prop_types52.default.object]),
    tickFontSize: import_prop_types52.default.number,
   ...
   * An array of [[AxisConfig]] objects.
   */
  yAxis: import_prop_types52.default.arrayOf(import_prop_types52.default.shape({
    classes: import_prop_types52.default.object,
    colorMap: import_prop_types52.default.oneOfType([import_prop_types52.default.shape({
      colors: import_prop_types52.default.arrayOf(import_prop_types52.default.string).isRequired,
      type: import_prop_types52.default.oneOf(["ordinal"]).isRequired,
    ...
    max: import_prop_types52.default.oneOfType([import_prop_types52.default.instanceOf(Date), import_prop_types52.default.number]),
    min: import_prop_types52.default.oneOfType([import_prop_types52.default.instanceOf(Date), import_prop_types52.default.number]),
    position: import_prop_types52.default.oneOf(["left", "right"]),
    reverse: import_prop_types52.default.bool,
    scaleType: import_prop_types52.default.oneOf(["band", "linear", "log", "point", "pow", "sqrt", "time", "utc"]),
    slotProps: import_prop_types52.default.object,
    slots: import_prop_types52.default.object,
